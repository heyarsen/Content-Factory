-- Migration: Expand video style constraint to include new styles and case-insensitive checks

-- 1. Drop existing constraint
ALTER TABLE videos DROP CONSTRAINT IF EXISTS videos_style_check;

-- 2. Normalize existing data to canonical casing
UPDATE videos
SET style = CASE
...
-- 3. Add case-insensitive constraint with expanded styles
ALTER TABLE videos
