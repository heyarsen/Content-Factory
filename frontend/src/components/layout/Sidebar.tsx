...
export function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  return (
    <Fragment>
      ...
      >
        <div
          className={`flex h-full flex-col border-r border-white/60 bg-white/80 backdrop-blur-xl shadow-[0_25px_70px_-35px_rgba(15,23,42,0.35)] transition-transform duration-300 ${
        ...
        >
          ...
          {hasVideos === false && (
            <div className="flex-shrink-0 px-6 pb-8">
              <div className="rounded-2xl border border-white/60 bg-white/70 p-5 text-sm text-slate-500 shadow-inner backdrop-blur">
