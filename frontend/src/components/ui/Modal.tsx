  ...
  return (
    ...
    >
      <div className="flex min-h-screen items-center justify-center px-4 pt-6 pb-10 text-center sm:block sm:p-0">
        ...
        <div
          className={`inline-block w-full transform overflow-hidden rounded-3xl border border-white/60 bg-white/95 text-left align-bottom shadow-[0_45px_95px_-55px_rgba(15,23,42,0.55)] backdrop-blur-xl transition-all sm:my-8 sm:align-middle ${sizes[size]}`}
