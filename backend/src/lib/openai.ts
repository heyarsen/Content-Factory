...
export async function generateScript(
  ...
  const systemPrompt = `You are a scriptwriter for short educational videos (15 seconds, about 40-45 words). Your task is to create an engaging, specific script with personality.
